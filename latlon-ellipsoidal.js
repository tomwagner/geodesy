 ...
 *
 * @example
 *     var p1 = new LatLon(51.4778, -0.0016, 156.3453, LatLon.datum.WGS84);
 */
function LatLon(lat, lon, h, datum) {
    // allow instantiation without 'new'
    if (!(this instanceof LatLon)) return new LatLon(lat, lon, h, datum);
...
LatLon.prototype.toCartesian = function() {
    ...
    var h = this.h; // height above ellipsoid - not currently used
